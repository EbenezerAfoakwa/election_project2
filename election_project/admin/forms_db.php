      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="side-menu-container">
          <ul class="nav navbar-nav">
            ...
            <li><a href="signup.php"><i class="fa-solid fa-user fa-lg" style="margin-right: 5px;"></i></i>CreateUser</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </nav>
    </div>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="users_db.php?id=<?php echo $row['id'] ?>"><i class="fa-solid fa-pen-to-square" style="color:#0AA1DD"></i></a>
                    <a href="users_db.php?id=<?php echo $row['id'] ?>"><i class="fa-solid fa-trash-can" style="color:red"></i></a>
                  </td> 
                </tr>
